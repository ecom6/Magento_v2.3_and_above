...
class Gateway extends \Magento\Payment\Model\Method\AbstractMethod {
	const _MODULE = 'Ecom6_PaymentGateway';
	const DIRECT_URL = 'https://gateway.ecom6.com/direct/';
	const HOSTED_URL = 'https://gateway.ecom6.com/hosted/';
			...
			if ($data['responseCode'] == 65802) {
				...
				if ($data['responseCode'] == 0){
					...
					if($order->getStatus() != $status) {
						...
						$objectManager->create('Ecom6\PaymentGateway\Model\Trans')
	...
	private function buildStatus($data) {
		$ordermessage = "Ecom6 Payment<br/><br/>" .
	...
	public function getOrderPlaceRedirectUrl() {
		return $this->_urlBuilder->getUrl('ecom6/order/process');
	}
}
